...
export type StudioEvent = "gate_pass" | "dataset_zip_downloaded" | "comfy_app_opened" | "prompt_app_opened" | "fal_train_started" | "fal_grid_started" | "waitlist_prepared" | "waitlist_copied";
