...
import "./globals.css";
import { assetPath, siteDescription, siteOrigin, socialImage } from "@/lib/site";

export const metadata: Metadata = {
  metadataBase: new URL(siteOrigin || "http://localhost:3000"),
  title: "U*TTU Studio — Look-Lock",
  ...
  openGraph: {
    ...
    title: "U*TTU Studio — Look-Lock", description: siteDescription,
    ...(siteOrigin ? { url: siteOrigin } : {}),
    images: [{ url: socialImage, width: 1200, height: 630, alt: "U*TTU Studio — Look-Lock. Une identité. Un canon. Un frein." }],
  },
  twitter: { card: "summary_large_image", title: "U*TTU Studio — Look-Lock", description: siteDescription, images: [socialImage] },
